...

{
  programs.hyprlock = {
    ...
    settings = {
      ...
      "$wallbash_txt1_rgba" = "rgba(255,255,255,0.95)";
      "$wallbash_txt2_rgba" = "rgba(255,255,255,0.95)";
      "$wallbash_pry4_rgba" = "rgba(64,73,101,0.95)";
      "$wallbash_pry2_rgba" = "rgba(37,36,55,0.95)";
      "$wallbash_3xa9_rgba" = "rgba(212,204,255,0.95)";
      "$wallbash_4xa9_rgba" = "rgba(204,216,255,0.95)";
